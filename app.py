...
# ==========================
APP_BUILD = "2026-01-06-provisional-icd-then-reason-v7"
...
with tabs[0]:
    ...
    reason_required = (str(referrer_cadre).strip() == "EMT") or (referrer_role == "Doctor/Physician")
    ...
    # Validation: EMT/Doctor must provide at least one of (reason, ICD)
    if reason_required and (not referral_reason and not chosen_icd):
        st.error("Please select reason(s) for referral or select an ICD diagnosis")
